            ...
            <div class="col-md-10">
                <div class="row">
                        <div class="col-12 mb-3 mt-3">
                            <a href="{{route('admin.purpose.create')}}" class="btn btn-primary">Add New Our Purpose</a>
                        </div>
                        <div class="col-12">
                            <table class="table table-bordered table-responsive-lg">
                                ...
                                @forelse($value as $val)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.purpose.edit',$val->id)}}"class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i></a>
                                            ...
                                            <form action="{{route('admin.purpose.destroy',$val->id)}}"  method="post" id="post-delete-{{$val->id}}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
