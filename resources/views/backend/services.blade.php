                            ...
                            <table class="table table-bordered table-responsive-lg">
                                ...
                                @forelse($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.service.edit',$service->id)}}"class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i></a>
                                            ...
                                            <form action="{{route('admin.service.destroy',$service->id)}}"  method="post" id="post-delete-{{$service->id}}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
