                ...
                <div class="create">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 mb-3 mt-3">
                            <a href="{{route('admin.about.create')}}" class="btn btn-primary">Add New Section</a>
                        </div>
                        <div class="col-12">
                            <table class="table table-bordered table-responsive-lg">
                                ...
                                @forelse($aboutSections as $aboutSection)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.about.section.edit',$aboutSection->id)}}"class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i></a>
                                            ...
                                            <form action="{{route('admin.about.section.destroy',$aboutSection->id)}}"  method="post" id="post-delete-{{$aboutSection->id}}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
